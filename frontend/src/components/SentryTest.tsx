    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div
            style={{ fontSize: "1.75rem", fontWeight: 800, color: "#dc2626" }}
          >
            {stats.errors}
          </div>
        </div>
        ...
        >
          ...
          <div
            style={{ fontSize: "1.75rem", fontWeight: 800, color: "#d97706" }}
          >
            {stats.warnings}
          </div>
        </div>
        ...
        >
          <div
            style={{ fontSize: "0.75rem", color: "#3730a3", fontWeight: 600 }}
          >
            TOTAL
          </div>
          <div
            style={{ fontSize: "1.75rem", fontWeight: 800, color: "#4f46e5" }}
          >
            {stats.total}
          </div>
        </div>
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: 700,
                      background:
                        event.source === "backend-api" ? "#dbeafe" : "#fce7f3",
                      color:
                        event.source === "backend-api" ? "#1e40af" : "#9f1239",
                    }}
                  >
                    {event.source}
                  </span>
